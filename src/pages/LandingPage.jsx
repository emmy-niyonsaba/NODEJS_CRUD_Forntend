  ...
  return (
    <div className="min-h-screen bg-blue-500 flex items-center justify-center px-5">
      <div className="text-center bg-white px-10 py-16 rounded-lg shadow-lg max-w-md w-full">
        {/* Logo Section */}
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-blue-500 m-0 mb-2">Manage Items</h1>
          <p className="text-lg font-medium text-blue-500 m-0 tracking-wide">Emmyson LTD Product</p>
        </div>
        ...
        <div className="mb-10">
          <p className="text-base text-gray-700 leading-relaxed">
            ...
            Create, update, and organize your items effortlessly. 
            Keep your product information organized and accessible anytime, anywhere.
          </p>
        </div>
